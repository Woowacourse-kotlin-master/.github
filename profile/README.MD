...
**[블로그: 우아한테크코스 경험과 코틀린으로 만든 앱](https://your-blog.com/kotlin-history-app)** ← 클릭하여 더 자세한 이야기 읽기
...
문의사항이 있으시면 Issues 탭을 통해 연락주세요.

**GitHub**: [yourusername/historyapp](https://github.com/yourusername/historyapp)
